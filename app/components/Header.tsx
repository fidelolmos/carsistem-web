  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 h-16 bg-white dark:bg-zinc-900 border-b border-gray-200 dark:border-zinc-800">
      <div className="flex items-center justify-between px-6 h-full">
        {/* Logo centrado respecto al sidebar (w-60 = 240px) */}
        ...
        <div className="flex items-center gap-4 ml-auto">
          ...
          <div className="relative" ref={userDropdownRef}>
            ...
            >
              ...
              <span className="body-text font-medium text-gray-900 dark:text-white">Admin</span>
              <svg
                width="16"
                height="16"
                viewBox="0 0 24 24"
            ...
            {showUserDropdown && (
              <div className="absolute top-full right-0 mt-2 w-56 bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded-lg shadow-lg overflow-hidden user-menu-dropdown">
                <button className="w-full px-4 py-2 text-left body-text text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-zinc-700 transition-colors border-b border-gray-200 dark:border-zinc-700">
                  Mi Cuenta
                </button>
                <button className="w-full px-4 py-2 text-left body-text text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-zinc-700 transition-colors border-b border-gray-200 dark:border-zinc-700">
                  Perfil
                ...
                <button className="w-full px-4 py-2 text-left body-text text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-zinc-700 transition-colors border-b border-gray-200 dark:border-zinc-700 flex items-center gap-2">
                ...
                <button
                  ...
                  className="w-full px-4 py-2 text-left body-text text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors flex items-center gap-2"
                >
